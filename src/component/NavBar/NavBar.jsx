...
import delivery from "../../assets/Vector (7).png";
const NavBar = () => {
  return (
    <nav>
      <div className="position-relative">
        ...
        <div className="loreg position-absolute d-flex w-100 justify-content-between container align-items-center start-0 end-0 top-0 mt-2 px-5">
